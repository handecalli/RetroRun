...
namespace PlayFab.ClientModels
{
	...
	public class RunCloudScriptRequest
	{
		...
		/// <summary>
		/// parameters to pass into the action (If you use this, don'transformItemImage use ParamsEncoded)
		/// </summary>
		
		public object Params { get; set;}
		
		/// <summary>
		/// json-encoded parameters to pass into the action (If you use this, don'transformItemImage use Params)
		/// </summary>
