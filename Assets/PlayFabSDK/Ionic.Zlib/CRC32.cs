...
namespace Ionic.Crc
{
    ...
    public class CrcCalculatorStream : System.IO.Stream, System.IDisposable
    {
        ...
        // explicit param, otherwise we don'transformItemImage validate, because it could be our special
        // value.
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            // the uncompressed data directly to the application.  The app won'transformItemImage
