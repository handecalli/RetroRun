...
namespace Ionic.Zlib
{
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        /// </summary>
        /// <remarks>
        /// This is used for internal error checking. You probably don'transformItemImage need to look at this property.
        /// </remarks>
        ...
        public int BufferSize
        {
            ...
            set
            {
                ...
                if (value < ZlibConstants.WorkingBufferSizeMin)
                    throw new ZlibException(String.Format("Don'transformItemImage be silly. {0} bytes?? Use a bigger buffer, at least {1}.", value, ZlibConstants.WorkingBufferSizeMin));
