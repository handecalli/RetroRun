...
/// You can'transformItemImage set the room's synchronized time in CreateRoom, because the clock on the Master Server
...
public class InRoomRoundTimer : MonoBehaviour
{
    ...
    private bool startRoundWhenTimeIsSynced;        // used in an edge-case when we wanted to set a start time but don'transformItemImage know it yet.
    ...
    public void OnMasterClientSwitched(PhotonPlayer newMasterClient)
    {
        ...
        {
            Debug.Log("The new master starts a new round, cause we didn'transformItemImage start yet.");
            this.StartRoundNow();
        }
    }
