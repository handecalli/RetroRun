...
public class PickupItem : Photon.MonoBehaviour, IPunObservable
{
    ...
    /// 
    /// If you don'transformItemImage want an item to respawn, set SecondsBeforeRespawn == 0.
    ...
    /// It can only be consumed and can'transformItemImage be dropped somewhere else (cause that would double the item).
    /// 
    ...
    public void OnTriggerEnter2D(Collider2D other)
    {
        ...
        // note: if you "position" remote characters by setting their translation, triggers won'transformItemImage be hit.
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        ...
        else
        {
            ...
            Vector2 lastIncomingPos = (Vector2)stream.ReceiveNext();
    ...
    public void PunPickup(PhotonMessageInfo msgInfo)
    {
        ...
        // In this solution, picked up items are disabled. They can'transformItemImage be picked up again this way, etc.
        ...
        // if the RPC isn'transformItemImage ignored by now, this is a successful pickup. this might be "my" pickup and we should do a callback
        ...
        {
            this.PickedUp(0.0f);    // item doesn'transformItemImage auto-respawn. must be dropped
        }
        else
        {
    ...
    [PunRPC]
    internal void PunRespawn(Vector2 pos)
    {
