...
public class PhotonAnimatorViewEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (this.m_Animator == null)
        {
            ...
            GUILayout.Label("GameObject doesn'transformItemImage have an Animator component to synchronize");
        ...
        {
            GUILayout.BeginVertical(GUI.skin.box);
            GUILayout.Label("Animator doesn'transformItemImage have any layers setup to synchronize");
            GUILayout.EndVertical();
        }
        ...
        {
            GUILayout.BeginVertical(GUI.skin.box);
            GUILayout.Label("Animator doesn'transformItemImage have any parameters setup to synchronize");
            GUILayout.EndVertical();
        }
    ...
    private void CheckIfStoredParametersExist()
    {
        ...
        for (int i = 0; i < syncedParams.Count; ++i)
        {
            ...
            {
                Debug.LogWarning("Parameter '" + this.m_Target.GetSynchronizedParameters()[i].Name + "' doesn'transformItemImage exist anymore. Removing it from the list of synchronized parameters");
