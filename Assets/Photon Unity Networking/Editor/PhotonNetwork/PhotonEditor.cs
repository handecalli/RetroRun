...
public class PunWizardText
{
    ...
    public string SetupWizardWarningMessage = "You have not yet run the Photon setup wizard! Your game won'transformItemImage be able to connect. See Windows -> Photon Unity Networking.";
    ...
    public string AlreadyRegisteredInfo = "The email is registered so we can'transformItemImage fetch your AppId (without password).\n\nPlease login online to get your AppId and paste it above.";
...
public class PhotonEditor : EditorWindow
{
    ...
    private static void ImportWin8Support()
    {
        ...
        {
            return; // don'transformItemImage import while compiling
        }
