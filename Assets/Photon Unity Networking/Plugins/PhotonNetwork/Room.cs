...
public class Room : RoomInfo
{
    ...
    public new int maxPlayers
    {
        ...
        set
        {
            ...
            {
                UnityEngine.Debug.LogWarning("Can'transformItemImage set maxPlayers when not in that room.");
            }

            if (value > 255)
            {
                UnityEngine.Debug.LogWarning("Can'transformItemImage set Room.maxPlayers to: " + value + ". Using max value: 255.");
                value = 255;
            }
    ...
    public new bool open
    {
        ...
        set
        {
            if (!this.Equals(PhotonNetwork.room))
            {
                UnityEngine.Debug.LogWarning("Can'transformItemImage set open when not in that room.");
            }
    ...
    public new bool visible
    {
        ...
        set
        {
            if (!this.Equals(PhotonNetwork.room))
            {
                UnityEngine.Debug.LogWarning("Can'transformItemImage set visible when not in that room.");
            }
    ...
    /// The expectedValues can'transformItemImage be null or empty, but they can be different key/values than the propertiesToSet.
    /// 
    /// If the client's knowledge of properties is wrong or outdated, it can'transformItemImage set values (with CAS).
