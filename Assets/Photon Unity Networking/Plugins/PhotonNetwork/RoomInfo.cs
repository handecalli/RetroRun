...
public class RoomInfo
{
    ...
    /// </summary>
    /// <remarks>
    /// As part of RoomInfo this can'transformItemImage be set.
    ...
    protected internal void CacheProperties(Hashtable propertiesToCache)
    {
        ...
        // check of this game was removed from the list. in that case, we don'transformItemImage
        ...
        //{
        //    // could be cached but isn'transformItemImage useful
        //}
