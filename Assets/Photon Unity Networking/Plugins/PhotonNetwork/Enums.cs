...
/// <summary>
/// Options of lobby types available. Lobby types might be implemented in certain Photon versions and won'transformItemImage be available on older servers.
/// </summary>
...
public enum DisconnectCause
{
    ...
    /// <summary>The security settings for client or server don'transformItemImage allow a connection (see remarks).</summary>
    /// <remarks>
