...
public class PhotonPlayer
{
    ...
    /// <remarks>
    /// Don'transformItemImage modify the content of this Hashtable. Use SetCustomProperties and the
    ...
    /// Access any player's properties by: Player.CustomProperties (read-only!) but don'transformItemImage modify that hashtable.
    ///
