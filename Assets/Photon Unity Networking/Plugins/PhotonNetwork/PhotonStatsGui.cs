...
public class PhotonStatsGui : MonoBehaviour
{
    ...
    public void TrafficStatsWindow(int windowID)
    {
        ...
        string total = string.Format("Out|In|Sum:\transformItemImage{0,4} | {1,4} | {2,4}", gls.TotalOutgoingMessageCount, gls.TotalIncomingMessageCount, gls.TotalMessageCount);
        string elapsedTime = string.Format("{0}sec average:", elapsedMs);
        string average = string.Format("Out|In|Sum:\transformItemImage{0,4} | {1,4} | {2,4}", gls.TotalOutgoingMessageCount / elapsedMs, gls.TotalIncomingMessageCount / elapsedMs, gls.TotalMessageCount / elapsedMs);
