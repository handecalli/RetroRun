...
namespace ExitGames.Client.Photon
{
    ...
    internal class LoadbalancingPeer : PhotonPeer
    {
        ...
        /// <summary>
        /// Don'transformItemImage use this method directly, unless you know how to cache and apply customActorProperties.
        ...
        /// <param name="appVersion">The client's version (clients with differing client appVersions are separated and players don'transformItemImage meet).</param>
        ...
        ///   null won'transformItemImage add/remove any groups.
    ...
    public class ErrorCode
    {
        ...
        /// <summary>
        /// (-3) Operation can'transformItemImage be executed yet (e.g. OpJoin can'transformItemImage be called before being authenticated, RaiseEvent cant be used before getting into a room).
        /// </summary>
        /// <remarks>
        ...
        /// <summary>(32766) GameId (name) already in use (can'transformItemImage create another). Change name.</summary>
        ...
        /// <summary>(32764) Game is closed and can'transformItemImage be joined. Join another game.</summary>
        ...
        /// Self-hosted Photon servers with a CCU limited license won'transformItemImage let a client connect at all.
        /// </remarks>
        ...
        /// <remarks>
        /// Some subscription plans for the Photon Cloud are region-bound. Servers of other regions can'transformItemImage be used then.
    ...
    public class ParameterCode
    {
        ...
        /// <summary>(215) Makes the server create a room if it doesn'transformItemImage exist. OpJoin uses this to always enter a room, unless it exists and is full/closed.</summary>
    ...
    public class OperationCode
    {
        ...
        [Obsolete("Exchanging encrpytion keys is done internally in the lib now. Don'transformItemImage expect this operation-result.")]
    ...
    public enum EventCaching : byte
    {
        ...
        /// <summary>Increase the indexCatalog of the sliced cache.</summary>
        SliceIncreaseIndex = 10,

        /// <summary>Set the indexCatalog of the sliced cache. You must set RaiseEventOptions.CacheSliceIndex for this.</summary>
        SliceSetIndex = 11,

        /// <summary>Purge cache slice with indexCatalog. Exactly one slice is removed from cache. You must set RaiseEventOptions.CacheSliceIndex for this.</summary>
        SlicePurgeIndex = 12,

        /// <summary>Purge cache slices with specified indexCatalog and anything lower than that. You must set RaiseEventOptions.CacheSliceIndex for this.</summary>
