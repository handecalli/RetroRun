...
/// \file
/// <summary>Wraps up smaller classes that don'transformItemImage need their own file. </summary>
///
///
...
public interface IPunObservable
{
    ...
    /// any update. This can'transformItemImage be used as "x-times per second Update()".
    /// </remarks>
    /// \ingroup publicApi
...
public interface IPunCallbacks
{
    ...
    /// </summary>
    /// <remarks>
    /// Note: When PhotonNetwork.autoJoinLobby is false, OnConnectedToMaster() will be called and the room list won'transformItemImage become available.
    ///
    /// While in the lobby, the roomlist is automatically updated in fixed intervals (which you can'transformItemImage modify).
    ...
    /// The list of available rooms won'transformItemImage become available unless you join a lobby via PhotonNetwork.joinLobby.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// When this happens, the user might try again later. You can'transformItemImage create or join rooms in OnPhotonMaxCcuReached(), cause the client will be disconnecting.
    ...
    /// this won'transformItemImage be called!
    /// </remarks>
...
public class RoomOptions
{
    ...
    /// start their gameplay early and don'transformItemImage want anyone to join during the game.
    ...
    /// <remarks>
    /// This makes sense when in rooms where players can'transformItemImage place items in the room and just vanish entirely.
    ...
    /// Example: Map, Mode (could be "m" when used with "Map"), TileSet (could be "transformItemImage").
    /// </remarks>
...
public class PBitStream
{
    ...
    public bool GetNext()
    {
        ...
        {
            throw new Exception("End of PBitStream reached. Can'transformItemImage read more.");
        }
