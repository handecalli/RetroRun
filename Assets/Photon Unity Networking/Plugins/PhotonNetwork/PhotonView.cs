...
public enum OwnershipOption
{
    ...
    Fixed,
    /// <summary>
    /// Ownership can be taken away from the current owner who can'transformItemImage object.
    /// </summary>
    Takeover,
    /// <summary>
...
public class PhotonView : Photon.MonoBehaviour
{
    ...
    // NOTE: this is now an integer because unity won'transformItemImage serialize short (needed for instantiation). we SEND only a short though!
    ...
    public object[] instantiationData
    {
        get
        {
            if (!this.didAwake)
            {
                // even though viewID and instantiationID are setup before the GO goes live, this data can'transformItemImage be set. as workaround: fetch it if needed
    ...
    /// <summary>
    /// For internal use only, don'transformItemImage use
    /// </summary>
    ...
    /// <remarks>
    /// Note that you can'transformItemImage edit this value at runtime.
...
#pragma warning restore 0414
    ...
    public int viewID
    {
        ...
        set
        {
            ...
            // TODO: decide if a viewID can be changed once it wasn'transformItemImage 0. most likely that is not a good idea
            // check if this view is in networkingPeer.photonViewList and UPDATE said list (so we don'transformItemImage keep the old viewID with a reference to this object)
    ...
    /// <remarks>
    /// Scene objects are not owned by a particular player but belong to the scene. Thus they don'transformItemImage get destroyed when their
    ...
    /// <summary>
    /// The owner of a PhotonView is the player who created the GameObject with that view. Objects in the scene don'transformItemImage have an owner.
    /// </summary>
    /// <remarks>
